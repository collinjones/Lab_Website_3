...
app.get('/team_stats', function(req, res) {
  var gamesPlayedQuery = "SELECT * FROM football_games;" //football_games table 
  var gamesWonQuery = "SELECT count(home_score) FROM football_games WHERE home_score > visitor_score;" //# of games won
  var gamesLostQuery = "SELECT count(home_score) FROM football_games WHERE home_score < visitor_score;" //# of losing games
  db.task('get-everything', task=> {
    return task.batch([
      task.any(gamesPlayedQuery),
      task.any(gamesWonQuery),
      task.any(gamesLostQuery)
    ])
  })
  .then(info => {
